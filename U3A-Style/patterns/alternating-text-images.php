...
<div class="wp-block-group">
  ...
  <div class="wp-block-columns are-vertically-aligned-center">
    ...
    <div class="wp-block-column" style="width:50%">
      ...
      <figure class="wp-block-image size-large">
        <img src="<?php echo get_theme_file_uri( 'assets/FridayTalks.JPG' ); ?>" alt="Community gathering" />
      </figure>
      <!-- /wp:image -->
    </div>
    <!-- /wp:column -->
  ...
  <div class="wp-block-columns are-vertically-aligned-center">
    ...
    <div class="wp-block-column" style="width:50%">
      <!-- wp:image {"sizeSlug":"large"} -->
      <figure class="wp-block-image size-large">
        <img src="<?php echo get_theme_file_uri( 'assets/learning.JPG' ); ?>" alt="Learning activity" />
      </figure>
      <!-- /wp:image -->
    </div>
    <!-- /wp:column -->
